...
public class BanklistAdapter_old extends RecyclerView.Adapter<BanklistAdapter_old.ViewHolder> {
    ...
    public BanklistAdapter_old(Context context, ArrayList<Bankdetails_model> items1) {
