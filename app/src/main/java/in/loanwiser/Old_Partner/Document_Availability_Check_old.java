...
import in.loanwiser.partnerapp.Documents.BottomSheetFragment;
...
public class Document_Availability_Check_old extends SimpleActivity {
    ...
    private String TAG = Document_Availability_Check_old.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objs.a.setStubId(this, R.layout.activity_document_availability_check_old);
    ...
    private void Document_Statues() {
        ...
        Log.e("the Document",J.toString());
        progressDialog.show();
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.Check_Uploadsubmit_old, J,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
    ...
    private void Documnet_upload_Status() {
        ...
        progressDialog.show();
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.submit_loanwiser_old, J,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(response.getString(Params.status).equals("success")){
                                Intent intent = new Intent(Document_Availability_Check_old.this, Submitsuccess_Activity.class);
    ...
    private void Bank_details_list() {
        ...
        progressDialog.show();
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.Eligible_Banklist_Old, J,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
   ...
   /* private void setAdapter_chile(JSONArray ja) {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            try {
               ...
               // Objs.a.NewNormalFontStyle(mCon,holder.class_name);
                ...
                holder.eligible_ly.setVisibility(View.GONE);
              ...
              //  String bank_logo_cc= "https://consumer.loanwiser.in/images/paysense.png";
               ...
               // Objs.a.loadPicasso(mCon,bank_logo_cc,holder.uploaded_yes,holder.progressBarMaterial);
                ...
                holder.upload.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent=new Intent(Document_Availability_Check_old.this, DocumentChecklist_Fragment.class);
                        startActivity(intent);
                ...
                holder.arrowimgdown1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        progressDialog.show();
                        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.get_partbankup_old, J,
                                new Response.Listener<JSONObject>() {
                                    @Override
                                    public void onResponse(JSONObject response) {
    ...
    private void Submit_Co_Applicant(){
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Document_Availability_Check_old.this, Upload_Activity_Bank_Old.class);
                startActivity(intent);
            }
        });
                        ...
                        try {
                            if(response.getBoolean(Params.status)){
                              ...
                              /*  Objs.ac.StartActivityPutExtra(DocGridView_List.this, Document_Details.class,
                                ...
                                Intent intent = new Intent(Document_Availability_Check_old.this, Document_Availability_Check_old.class);
                                startActivity(intent);
...
*//*
    ...
    public void onBackPressed() {
        ...
        Pref.removeAEID(mCon);
            Intent intent = new Intent(Document_Availability_Check_old.this,Home_Old.class);
            startActivity(intent);
            finish();
            super.onBackPressed();
