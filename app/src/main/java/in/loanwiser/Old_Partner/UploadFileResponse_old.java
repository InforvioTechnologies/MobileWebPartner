...
public class UploadFileResponse_old {
    ...
    public UploadFileResponse_old withRequest(Request request) {
        this.request = request;
        return this;
    }
    ...
    public UploadFileResponse_old withResponse(Response response) {
        this.response = response;
        return this;
    }
