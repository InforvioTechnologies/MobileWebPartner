...
public class Applicant_Doc_Details_revamp_old extends SimpleActivity {
    ...
    private String TAG = Applicant_Doc_Details_revamp_old.class.getSimpleName();
    ...
    private void Document_generate_checklist_rule() {
        ...
        progressDialog.show();
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.generate_docuverifyrule_old, J,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(response.getString("status").equals("success")){
                                ...
                                Intent intent = new Intent(Applicant_Doc_Details_revamp_old.this, Document_Availability_Check_old.class);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(response.getString(Params.status).equals("success")){
                                Intent intent = new Intent(Applicant_Doc_Details_revamp_old.this, Submitsuccess_Activity.class);
                                startActivity(intent);
    ...
    private void Document_Details() {
        ...
        progressDialog.show();
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.DOCUMENT_CHECK_LIST_old, J,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
    ...
    private void Document_Details1() {
        ...
        progressDialog.show();
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.Get_DocumentcklistProp_old, J,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
   ...
   /* private void setAdapter_chile(JSONArray ja) {
                    ...
                    public void onClick(View view) {
                        ...
                        try {
                           ...
                           // String document_req = J.getString("document_req");
                            ...
                            Intent intent = new Intent(Applicant_Doc_Details_revamp_old.this, Document_Details.class);
    ...
    public void showBottomSheetDialogFragment() {
        BottomSheetFragment_old bottomSheetFragment = new BottomSheetFragment_old();
    ...
    private void Submit_Co_Applicant(){
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Applicant_Doc_Details_revamp_old.this, Upload_Activity_Bank.class);
                startActivity(intent);
            }
        });
                        ...
                        try {
                            if(response.getBoolean(Params.status)){
                              ...
                              /*  Objs.ac.StartActivityPutExtra(DocGridView_List.this, Document_Details.class,
                                ...
                                Intent intent = new Intent(Applicant_Doc_Details_revamp_old.this, Applicant_Doc_Details_revamp_old.class);
                                startActivity(intent);
    ...
    public void onBackPressed() {
        ...
        Pref.removeAEID(mCon);
            Intent intent = new Intent(Applicant_Doc_Details_revamp_old.this,Home_Old.class);
            startActivity(intent);
            finish();
            super.onBackPressed();
