...
import in.loanwiser.partnerapp.PartnerActivitys.Applicant_Info_new;
...
import in.loanwiser.partnerapp.PartnerActivitys.Viability_Data_revamp_old;
...
public class Home_Old extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  Objs.ac.ApplyFont(toolbar, mCon);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(Home_Old.this);
        Log.i("TAG", "onCreate:Home_Old "+"Homeclass");
      ...
      /*  call_phone.setOnClickListener(new View.OnClickListener() {
        ...
        call_phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(Home_Old.this, "Could not find an activity to place the call.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        view_activity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Home_Old.this, ActivityStreamActivity.class);
                startActivity(intent);
    ...
    public void Applicant_Status() {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.PARTNER_STATUES_IDs_old, J,
                        ...
                        try {
                            ...
                            if(statues.equals("success"))
                            {
                              ...
                              //  applicant_id =  "APP-"+user_id;
                                ...
                                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(Home_Old.this);
       ...
       // Credite_report_image = (ImageView) findViewById(R.id.Credite_report_image);
        ...
        view_ask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Home_Old.this, Ask_user_Dashboard_Activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        step2viablity_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    //  Intent intent = new Intent(Home_Old.this, Viability_Activity_Data_View.class);
                    //vehicle loan type
                 if(loan_type_id.equals("22"))
                {
                    Intent intent = new Intent(Home_Old.this, in.loanwiser.partnerapp.Credit_Vehicle_.Viability_Data_revamp_old.class);
                ...
                {
                    Intent intent = new Intent(Home_Old.this, Viability_Data_revamp_old.class);
                    intent.putExtra("user_id", user_id);
                    intent.putExtra("transaction_id", transaction_id);
                    startActivity(intent);
                }
                ...
                }else
                {
                    ...
                    if(loan_type_id.equals("21"))
                    {
                        ...
                        Intent intent = new Intent(Home_Old.this, Viability_Screen_revamp_Pl_BL.class);
                        intent.putExtra("user_id", user_id);
                        intent.putExtra("transaction_id", transaction_id);
                        startActivity(intent);
                        // finish();
                    ...
                    {
                        Intent intent = new Intent(Home_Old.this, in.loanwiser.partnerapp.Credit_Vehicle_.Viability_Screen_revamp.class);
                        intent.putExtra("user_id", user_id);
                        intent.putExtra("transaction_id", transaction_id);
                        startActivity(intent);
                        //  finish();
                    ...
                    {
                        Intent intent = new Intent(Home_Old.this, in.loanwiser.partnerapp.Credit_Vehicle_.Viability_Screen_revamp_Pl_BL.class);
                        intent.putExtra("user_id", user_id);
                        intent.putExtra("transaction_id", transaction_id);
                        startActivity(intent);
                        //  finish();
                    ...
                    {
                        Intent intent = new Intent(Home_Old.this, Viability_Screen_revamp.class);
                        startActivity(intent);
                        // finish();
                    }
        ...
        step2payment_but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(viability.equals("completed")) {
                    ...
                    {
                        Intent intent = new Intent(Home_Old.this, PaymentActivity.class);
                        startActivity(intent);
                        // finish();
                    }
            ...
            public void onClick(View view) {
                if(payment.equals("completed"))
                {
                    if((viability.equals("completed") && crif_report.equals("completed")) || (viability.equals("completed") && crif_report.equals("error")))  {
                        ...
                        if(reject_status.equals("1"))
                        {
                          ...
                          /* String report="Viability Report";
                            Objs.ac.StartActivityPutExtra(Home_Old.this, Doc_ImageView_Bank.class,
                                    Params.document,viability_report_URL,Params.report,report);*/

                            /*if (permissionUtils.checkPermission(Home_Old.this, STORAGE_PERMISSION_REQUEST_CODE, view)) {
                            ...
                            String report="Viability Report";
                            Intent intent = new Intent(Home_Old.this, MainActivity.class);
                    ...
                    }else
                    {
                        ...
                        {
                            Intent intent = new Intent(Home_Old.this, Payment_Sucess_Screen.class);
                            startActivity(intent);
                        }
            ...
            public void onClick(View view) {
                if(viability.equals("completed")) {
                    if (payment.equals("completed")) {
                        ...
                        {
                            Intent intent = new Intent(Home_Old.this, CRIF_Report_Activity_PDF_View.class);
                ...
                if(viability.equals("completed")) {
                    if (payment.equals("completed")) {
                        ...
                        if(crif_report.equals("completed"))
                        {
                            ...
                            {
                                Intent intent = new Intent(Home_Old.this, Upload_Activity_Bank_Old.class);
                                startActivity(intent);
                            }else
                            {
                                Intent intent = new Intent(Home_Old.this, Upload_Activity_Bank_Old.class);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(response.getString("status").equals("success")){
                                ...
                                Intent intent = new Intent(Home_Old.this, Document_Availability_Check_old.class);
                                startActivity(intent);
                            }else {
   ...
   private void Step_copletions() {
       ...
       //  progressDialog.show();
       JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.Lead_Details_statues_Old, J,
               new Response.Listener<JSONObject>() {
                   @Override
                   public void onResponse(JSONObject response) {
                       try {
    ...
    private void Work_flow_status() {
       ...
       // progressDialog.show();
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.PARTNER_STATUES_old, J,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                             ...
                             Log.e("Home_Old List",String.valueOf(response));
    ...
    private void Paymentplanshow() {
       ...
       /* Typeface font = Typeface.createFromAsset(Home_Old.this.getAssets(), "segoe_ui.ttf");
...
*/
        Applicant_info_ly.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Home_Old.this, Applicant_Info_new.class);
                startActivity(intent);
            }
        });
            ...
            public void onClick(View view) {
                if(bank_statement.equals("completed"))
                {
                    ...
                    }else
                    {
                        ...
                        {
                            // Account_Listings_Details(user_id);
                            Intent intent = new Intent(Home_Old.this, Applicant_Doc_Details_revamp_old.class);
            ...
            public void onClick(View view) {
                ...
                if(bank_statement.equals("completed"))
                {
                    if(document_checklist.equals("pending"))
                    {
                        ...
                        Intent intent=new Intent(Home_Old.this, DocumentChecklist_Fragment.class);
                        intent.putExtra("jsonArray", Applicant_Statues.toString());
...
/*        findViewById(R.id.document_Upload).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(document_checklist.equals("pending"))
                {
                 ...
                 Intent intent=new Intent(Home_Old.this, DocumentChecklistActivity.class);
                 intent.putExtra("jsonArray", Applicant_Statues.toString());
                 intent.putExtra("applicantcount",applicant_count);
                 intent.putExtra("propertyidentify",property_identified);
                 startActivity(intent);
