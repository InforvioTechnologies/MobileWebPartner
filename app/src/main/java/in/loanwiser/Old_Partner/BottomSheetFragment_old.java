 ...
 * </pre>
 */
public class BottomSheetFragment_old extends BottomSheetDialogFragment {

    Button cameralay,gallerylay,pdflay;

    public BottomSheetFragment_old() {
      ...
      /*  cameralay.setOnClickListener(new View.OnClickListener() {
        ...
        cameralay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getActivity(), ManiActivity_Image2_old.class);
