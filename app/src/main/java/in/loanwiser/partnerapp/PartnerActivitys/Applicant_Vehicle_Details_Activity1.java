...
public class Applicant_Vehicle_Details_Activity1 extends SimpleActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objs.a.setStubId(this, R.layout.activity_applicant__vehicle__details_1);
        ...
        float_chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Objs.ac.StartActivity(mCon, MainActivity_Vehicle_Add_Lead1.class);
                finish();
            }
        });
    ...
    private void setAdapter(JSONArray ja) {
        Applicant_Vehicle_Details_Activity1.ListItemAdapter adapter = new Applicant_Vehicle_Details_Activity1.ListItemAdapter(mCon,ja);
    ...
    public class ListItemAdapter extends RecyclerView.Adapter<ListItemAdapter.ViewHolder> {
        ...
        @Override
        public Applicant_Vehicle_Details_Activity1.ListItemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.ly_track_status, parent, false);
            return new Applicant_Vehicle_Details_Activity1.ListItemAdapter.ViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(final Applicant_Vehicle_Details_Activity1.ListItemAdapter.ViewHolder holder, final int position) {
            try {
