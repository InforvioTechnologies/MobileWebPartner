...
public class MainActivity_Add_Lead1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main__add__lead1);

        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(mToolbar);
        Objs.ac.ApplyFont(mToolbar, mCon);
        Objs.ac.BackButton(MainActivity_Add_Lead1.this, mToolbar);
