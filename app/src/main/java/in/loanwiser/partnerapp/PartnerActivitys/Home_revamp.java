...
public class Home_revamp extends AppCompatActivity {
        ...
        call_phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(Home_revamp.this, "Could not find an activity to place the call.", Toast.LENGTH_SHORT).show();
                }
            }
        });
       ...
       // Credite_report_image = (ImageView) findViewById(R.id.Credite_report_image);
        ...
        Viability_Check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Intent intent = new Intent(Home_revamp.this, Viability_Activity_Data_View.class);
                ...
                }else
                {
                    ...
                    if(loan_type_id.equals("21"))
                    {
                        ...
                        Intent intent = new Intent(Home_revamp.this, Viability_Check_PL.class);
                        intent.putExtra("user_id", user_id);
                        intent.putExtra("transaction_id", transaction_id);
                        startActivity(intent);
                       // finish();
                    ...
                    {
                        Intent intent = new Intent(Home_revamp.this, Viability_Check_BL.class);
                        intent.putExtra("user_id", user_id);
                        intent.putExtra("transaction_id", transaction_id);
                        startActivity(intent);
                      //  finish();
                    ...
                    {
                        Intent intent = new Intent(Home_revamp.this, Viability_Check_HL_new.class);
                        startActivity(intent);
                       // finish();
                    }
                ...
                if(viability.contains("completed"))
                {
                    ...
                    }else
                    {
                        if(loan_type_id.equals("21"))
                        {
                            ...
                            Intent intent = new Intent(Home_revamp.this, Eligibility_Check_PL.class);
                            intent.putExtra("user_id", user_id);
                            intent.putExtra("transaction_id", transaction_id);
                            startActivity(intent);
                           // finish();
                        ...
                        {
                            Intent intent = new Intent(Home_revamp.this, Eligibility_BL.class);
                            intent.putExtra("user_id", user_id);
                            intent.putExtra("transaction_id", transaction_id);
                            startActivity(intent);
                           // finish();
                        ...
                        {
                            Intent intent = new Intent(Home_revamp.this, Eligibility_HL_New.class);
                            startActivity(intent);
                           // finish();
                        }
                    }
                ...
                if(viability.contains("completed")) {
                    ...
                    if (eligibility.contains("completed")) {
                        ...
                        if (payment.contains("completed")) {
                            ...
                            {
                                Intent intent = new Intent(Home_revamp.this, Creadite_Report_Activity.class);
                                startActivity(intent);
                                finish();
                            }
            ...
            public void onClick(View view) {
                ...
                if(viability.contains("completed")) {
                    if (eligibility.contains("completed")) {
                        ...
                        {
                            Intent intent = new Intent(Home_revamp.this, PaymentActivity.class);
                            startActivity(intent);
                            // finish();
                        }
                    }else
        ...
        viability_Report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    if (permissionUtils.checkPermission(Home_revamp.this, STORAGE_PERMISSION_REQUEST_CODE, view)) {
                ...
                if(viability.contains("completed")) {
                    if (eligibility.contains("completed")) {
                        if (payment.contains("completed")) {
                            if(credit_request.contains("completed"))
                            {
                                Intent intent = new Intent(Home_revamp.this, CRIF_Report_Activity_PDF_View.class);
                        ...
                        if (payment.contains("completed")) {
                            if(credit_request.contains("completed"))
                            {
                                ...
                                }else
                                {
                                    ...
                                    Intent intent = new Intent(Home_revamp.this, Upload_Activity_Bank.class);
                                    startActivity(intent);
                                }
...
*/
        Applicant_info_ly.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Home_revamp.this,Applicant_Info_new.class);
                startActivity(intent);
            }
        });
        ...
        findViewById(R.id.Document_Upload).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(document_checklist.contains("pending"))
                {
                    Intent intent = new Intent(Home_revamp.this, Document_Checklist_Details_type.class);
