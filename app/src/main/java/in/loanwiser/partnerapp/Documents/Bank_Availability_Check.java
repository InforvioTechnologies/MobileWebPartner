...
public class Bank_Availability_Check extends SimpleActivity {
    ...
    private String TAG = Bank_Availability_Check.class.getSimpleName();
    ...
    RecyclerView recycler_view_bank_eligible,recycler_view_not_bank_eligible,recycler_view_not_bank_eligible1;
    ...
    LinearLayout bank_eligible_not_met1;
    @Override
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.status_update, J,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        Intent intent = new Intent(Bank_Availability_Check.this, Elegibility_Report.class);
              ...
              //  String bank_logo_cc= "https://consumer.loanwiser.in/images/paysense.png";
               ...
               // Objs.a.loadPicasso(mCon,bank_logo_cc,holder.uploaded_yes,holder.progressBarMaterial);
                ...
                holder.upload.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent=new Intent(Bank_Availability_Check.this, Applicant_Doc_Details_revamp.class);
                        startActivity(intent);
...
*/
    ...
    private void Submit_Co_Applicant(){
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Bank_Availability_Check.this, Upload_Activity_Bank.class);
                startActivity(intent);
            }
        });
                        ...
                        try {
                            if(response.getBoolean(Params.status)){
                              ...
                              /*  Objs.ac.StartActivityPutExtra(DocGridView_List.this, Document_Details.class,
                                ...
                                Intent intent = new Intent(Bank_Availability_Check.this, Bank_Availability_Check.class);
                                startActivity(intent);
