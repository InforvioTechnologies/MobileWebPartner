...
public class DocGridView_List1 extends SimpleActivity {

    Context mCon;
    private String tag_json_obj = "jobj_req", tag_json_arry = "jarray_req";
    private String TAG = DocGridView_List1.class.getSimpleName();
    private AlertDialog progressDialog;
    String id,doc_name,docid,class_id,user_type,transaction_id,doc_id;
    String _class_id,_transaction_id,_user_type,_doc_id,type,applicant_name;
       ...
       // Log.d("applicant_name",applicant_name);
        ...
        fab_add_more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Objs.ac.StartActivityPutExtra(DocGridView_List1.this, MainActivity_IMG_Property2.class,
                        Params.id,id
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Log.e("Image Response 1", String.valueOf(response));
    ...
    private void setAdapter(JSONArray ja) {
        DocGridView_List1.ListItemAdapter adapter = new DocGridView_List1.ListItemAdapter(DocGridView_List1.this,ja);
        // Objs.a.getRecyleview_horizontal(this).setAdapter(adapter);
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(DocGridView_List1.this, 2);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new DocGridView_List1.GridSpacingItemDecoration(2, dpToPx(10), true));
    ...
    public class ListItemAdapter extends RecyclerView.Adapter<ListItemAdapter.ViewHolder> {
        ...
        @Override
        public DocGridView_List1.ListItemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.ly_image_list, parent, false);
          //  return new DocGridView_List.ListItemAdapter.ViewHolder(itemView);
            return new DocGridView_List1.ListItemAdapter.ViewHolder(itemView);
        }
        @Override
        public void onBindViewHolder(final DocGridView_List1.ListItemAdapter.ViewHolder holder, final int position) {
            try {
                J = getItem(position);
                ...
                holder.Ly_item.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        try {
                            ...
                            ExitAlert(DocGridView_List1.this,type,doc,hash);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    public void ExitAlert(final Context context, final String type, final String doc, final String hash) {
        android.support.v7.app.AlertDialog.Builder builder =
                new android.support.v7.app.AlertDialog.Builder(context, adhoc.app.applibrary.R.style.MyAlertDialogStyle);
        ...
        builder.setNeutralButton("View", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Objs.ac.StartActivityPutExtra(DocGridView_List1.this, Doc_ImageView.class, Params.type,type,
                        Params.document,doc,
                        Params.hash,hash);
            }
        });
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if(response.getBoolean(Params.status)){
                                ...
                                Objs.a.showToast(DocGridView_List1.this, "Succussfully deleted the Document...");

                                Objs.ac.StartActivityPutExtra(DocGridView_List1.this, Applicant_Doc_Details_Property.class,
                                        Params.user_type,user_type);
                                finish();
                            }else{
