...
public class Pic_Doc_File extends AppCompatActivity implements PickiTCallbacks {
    //Permissions
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pic__doc__file);
        init();
        buttonClickEvent();
        ...
        if (requestCode == SELECT_VIDEO_REQUEST) {
            if (resultCode == RESULT_OK) {
                ...
                if (data.getClipData() != null) {
                    ...
                    Log.e("the Path is,", String.valueOf(data.getClipData().getItemAt(i).getUri()));
                    Log.e("the Path is,", String.valueOf(data.getClipData().getItemAt(i).getUri()));
                    }
    ...
    public void PickiTonCompleteListener(String path, boolean wasDriveFile, boolean wasUnknownProvider, boolean wasSuccessful, String reason) {
        ...
        if (wasSuccessful) {
            ...
            uriarrayList.add(new File(path));
            pickitTv.setText(uriarrayList.toString());
