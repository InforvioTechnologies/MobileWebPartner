...
public class AcadmyDetails_sales {
    ...
    public AcadmyDetails_sales(String thumbnail, String title, String description, String pdf_url, String video_status, String video_url) {
        this.thumbnail = thumbnail;
        this.title = title;
        this.description = description;
        this.pdf_url = pdf_url;
