...
public class BanklistAdapter1 extends RecyclerView.Adapter<BanklistAdapter1.ViewHolder> {
    ...
    public BanklistAdapter1(Context context, ArrayList<Bankdetails_model> items1) {
        ...
        holder.viewbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               /* Objs.ac.StartActivityPutExtra(context, BankAnalysis.class,
                ...
                Intent in=new Intent(context,BankAnalysis1.class);
