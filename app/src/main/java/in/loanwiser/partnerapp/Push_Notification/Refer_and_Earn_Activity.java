...
public class Refer_and_Earn_Activity extends AppCompatActivity {
    private Uri mInvitationUrl;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_refer_and__earn_);
        ...
        createLink();
      //  Log.e("the link",mInvitationUrl.toString());
    }
      ...
      //  String uid = user.getUid();
        ...
        FirebaseDynamicLinks.getInstance().createDynamicLink()
                ...
                .setAndroidParameters(
                        new DynamicLink.AndroidParameters.Builder("in.loanwiser.partnerapp")
