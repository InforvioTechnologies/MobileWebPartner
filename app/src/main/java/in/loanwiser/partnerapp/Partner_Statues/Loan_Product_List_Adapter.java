...
public class Loan_Product_List_Adapter extends RecyclerView.Adapter<Loan_Product_List_Adapter.CustomViewHolder> {

    private Context context;
    private ArrayList<AcadmyDetails_Loan_Process> items;
    ...
    public Loan_Product_List_Adapter(Context context, ArrayList<AcadmyDetails_Loan_Process> items) {
