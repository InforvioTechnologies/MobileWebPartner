...
public class Intro_List_Adapter extends RecyclerView.Adapter<Intro_List_Adapter.CustomViewHolder> {

    private Context context;
    private ArrayList<AcadmyDetails> items;
    ...
    public Intro_List_Adapter(Context context, ArrayList<AcadmyDetails> items) {
