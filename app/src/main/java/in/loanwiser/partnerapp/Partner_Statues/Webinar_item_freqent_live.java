...
public class Webinar_item_freqent_live {
    ...
    public Webinar_item_freqent_live(String title, String description, String scheduled_time, String url, String thumbnail_url
