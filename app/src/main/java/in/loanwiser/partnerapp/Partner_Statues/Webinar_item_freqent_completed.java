...
public class Webinar_item_freqent_completed {
    ...
    public Webinar_item_freqent_completed(String title, String description, String scheduled_time, String url, String thumbnail_url
