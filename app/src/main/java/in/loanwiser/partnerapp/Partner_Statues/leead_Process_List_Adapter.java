...
public class leead_Process_List_Adapter extends RecyclerView.Adapter<leead_Process_List_Adapter.CustomViewHolder> {

    private Context context;
    private ArrayList<AcadmyDetails_Lead_Process> items;
    ...
    public leead_Process_List_Adapter(Context context, ArrayList<AcadmyDetails_Lead_Process> items) {
