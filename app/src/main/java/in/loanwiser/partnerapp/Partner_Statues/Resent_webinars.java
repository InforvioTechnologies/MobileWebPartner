...
public class Resent_webinars extends RecyclerView.Adapter<Resent_webinars.CustomViewHolder> {

    private Context context;
    private ArrayList<Webinar_item_freqent> items;
    ...
    public Resent_webinars(Context context, ArrayList<Webinar_item_freqent> items) {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, final int position) {
      ...
      //  holder.bindPost(posts.get(position));
       ...
       // String url  = "https:\\/\\/meet.google.com\\/uma-poau-eck";
      ...
      //  holder.thumb_nile_image.setImageDrawable(context.getResources().getDrawable(R.drawable.presentation));
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        private AppCompatTextView webinar_topic,webinar_topi_des,webinar_time,watch_webinar,Statues_update,webinar_register,webinar_time1;
    ...
    public void Register_Webinar(String b2b_id,String webinar_id) {
       ...
       // final String step_status11 = step_status1;
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST, Urls.webinar_register, J,
