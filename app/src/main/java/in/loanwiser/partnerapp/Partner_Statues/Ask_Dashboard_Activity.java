...
public class Ask_Dashboard_Activity extends AppCompatActivity implements OnLoadMoreListener {
...
//    View drawerView;
    ...
    private String TAG = Ask_Dashboard_Activity.class.getSimpleName();
    ...
    Ask_LeadListAdapter_Dashboard leadListAdapter_dashboard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ask_dash_board_new);
     ...
     //   Objs.ac.BackButton(mCon, toolbar);
        getSupportActionBar().setTitle("Ask List");
   ...
   //     S_status_id = "0";
     ...
     //   drawerLayout = (DrawerLayout)findViewById(R.id.drawer_layout);
        ...
        leadListAdapter_dashboard = new Ask_LeadListAdapter_Dashboard(this);
    ...
    public void ExitAlert(Context context) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(Ask_Dashboard_Activity.this, Welcome_Page.class);
   ...
   /* private void setAdapter(JSONArray ja) {
    ...
    public class ListItemAdapter extends RecyclerView.Adapter<ListItemAdapter.ViewHolder> {
        ...
        @Override
        public Ask_Dashboard_Activity.ListItemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.ly_new_lead_status, parent, false);
            return new Ask_Dashboard_Activity.ListItemAdapter.ViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(final Ask_Dashboard_Activity.ListItemAdapter.ViewHolder holder, final int position) {
            try {
