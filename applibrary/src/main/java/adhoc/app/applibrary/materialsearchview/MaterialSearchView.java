package adhoc.app.applibrary.materialsearchview;
...
import adhoc.app.applibrary.BuildConfig;
import adhoc.app.applibrary.R;
import adhoc.app.applibrary.materialsearchview.adapters.CursorSearchAdapter;
import adhoc.app.applibrary.materialsearchview.db.HistoryContract;
import adhoc.app.applibrary.materialsearchview.utils.AnimationUtils;
...
public class MaterialSearchView extends CoordinatorLayout {
        ...
        if(typedArray != null) {
            ...
            if (typedArray.hasValue(R.styleable.MaterialSearchView_android_textColorHint)) {
                setHintTextColor(typedArray.getColor(R.styleable.MaterialSearchView_android_textColorHint,
                        ContextCompat.getColor(mContext,R.color.colorBlack_overlay)));
            }
     ...
     */
    public void displayVoiceButton(boolean display) {
