package adhoc.app.applibrary.materialsearchview.db;
...
public class HistoryContract {
    ...
    private static String initAuthority() {
        String authority = "adhoc.app.applibrary.materialsearchview.defaultsearchhistorydatabase";

        try {
            ClassLoader clazzLoader = HistoryContract.class.getClassLoader();
            Class<?> clazz = clazzLoader.loadClass("adhoc.app.yoursouk.MsvAuthority");
